...
# gastos em uma viagem, ao utilizar um automóvel que faz 12 KM/L. Para isso, ele gostaria que você 
...
tempoGastoViagem = int(input());
velocidadeMedia = int(input());
automovel = 12;

result = tempoGastoViagem * velocidadeMedia;
result = result/automovel;
